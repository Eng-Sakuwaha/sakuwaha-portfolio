    ...
    <>
      <nav className="navbar" role="navigation" aria-label="Main navigation">
        <div className="container nav-inner">
          <a href="#home" className="nav-logo" aria-label="Sakuwaha Henry – Home">
            Sakuwaha Henry
          </a>
          ...
          <div className="nav-cta">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="nav-icon-link nav-icon-whatsapp"
            ...
            <a href={personalInfo.cvPath} className="btn btn-primary" download aria-label="Download CV as PDF">
      ...
      <div className={`mobile-menu ${menuOpen ? 'open' : ''}`} role="menu" aria-label="Mobile navigation">
        {navLinks.map((link) => (
          <a key={link.href} href={link.href} role="menuitem" onClick={closeMenu}>
            {link.label}
          </a>
        ))}
